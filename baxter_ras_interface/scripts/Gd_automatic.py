	...
	if n==0:
		for x_1 in range(n_1):
			...
			if M["m00"]>0:
				...
				if area>100 and y<400:
					center=x,y
					if area<minarea and y<400:
						ar=area
					beta=beta+1
...
def callback(message):
    ...
    x_red1,y_red1=centro(137,75,frame)
    x_blue1,y_blue1=centro(180,70,frame)
    x_obs1,y_obs1=centro(230,83,frame)
    x_obs2,y_obs2=centro(269,80,frame)
    x_orange1,y_orange1=centro(303,67,frame)
    x_obs3,y_obs3=centro(347,80,frame)
    x_obs4,y_obs4=centro(387,82,frame)
    x_obs5,y_obs5=centro(423,80,frame)
    x_green1,y_green1=centro(468,63,frame)
####
    x_orange2,y_orange2=centro(137,120,frame)
    x_obs6,y_obs6=centro(182,130,frame)
    x_red2,y_red2=centro(223,117,frame)
    x_obs7,y_obs7=centro(267,126,frame)
    x_green2,y_green2=centro(310,113,frame)
    x_obs8,y_obs8=centro(347,123,frame)
    x_blue2,y_blue2=centro(392,115,frame)
    x_obs9,y_obs9=centro(432,117,frame)
    x_obs10,y_obs10=centro(471,118,frame)
####
    x_obs11,y_obs11=centro(139,185,frame)
    x_orange3,y_orange3=centro(172,176,frame)
    x_obs12,y_obs12=centro(223,185,frame)
    x_green3,y_green3=centro(262,173,frame)
    x_red3,y_red3=centro(306,173,frame)
    x_obs13,y_obs13=centro(350,183,frame)
    x_obs14,y_obs14=centro(395,175,frame)
    x_blue3,y_blue3=centro(438,165,frame)
    x_obs15,y_obs15=centro(478,175,frame)
####    
    x_obs16,y_obs16=centro(137,241,frame)
    x_green4,y_green4=centro(169,236,frame)
    x_blue4,y_blue4=centro(215,238,frame)
    x_obs17,y_obs17=centro(270,231,frame)
    x_obs18,y_obs18=centro(312,230,frame)
    x_orange4,y_orange4=centro(354,222,frame)
    x_obs19,y_obs19=centro(400,227,frame)
    x_obs20,y_obs20=centro(445,226,frame)
    x_red4,y_red4=centro(485,220,frame)
    if a<200:
