...
class RecojerCubo(object):
	...
	speed=1
        self._guarded_move_to_joint_position(start_angles,speed)
        self.gripper_open()
        #rospy.sleep(1.0)
    ...
    def _guarded_move_to_joint_position(self, joint_angles,speed):
        if joint_angles:
	...
	speed=0.3
        self._guarded_move_to_joint_position(joint_angles,speed)
...
def matriz1(x,y):
	...
	return matriz
def right(matriz,block_poses,posinicialz,overhead_orientation,idx,Cub2,Cub,starting_joint_angles,starting_joint_angles2,posinicialx,posinicialy):
	x=matriz[1][4][0]
	y=matriz[1][4][1]
	posinicialx_1=y
	posinicialy_1=x
...
def left(matriz,block_poses,posinicialz,overhead_orientation,idx,Cub2,Cub,starting_joint_angles,starting_joint_angles2,posinicialx,posinicialy):
	x=matriz[1][4][0]
	y=matriz[1][4][1]
	posinicialx_1=y
	posinicialy_1=x
...
def moverbaxter(puntoa,puntob):
		...
		if x_1<0:
			...
			if y>=nox1:	
				print '1'
				if x>=der_noy1:
					left(matriz,block_poses,posinicialz,overhead_orientation,idx,Cub2,Cub,starting_joint_angles,starting_joint_angles2,posinicialx,posinicialy)
				else:
		...
		if x_1>0:
			...
			if y>=nox1:
				if abs(x)>= abs(izq_noy1) and x<0:
					right(matriz,block_poses,posinicialz,overhead_orientation,idx,Cub2,Cub,starting_joint_angles,starting_joint_angles2,posinicialx,posinicialy)
				else:
