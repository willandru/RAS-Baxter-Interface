...
def callback(data):
    ...
    Avanzar_n_Estados_Correctos.main(matriz,dificultad,avanzar)
    terminar='Acabe'
    vector3=Twist()
    vector3.linear.z=2
...
def main():
    ...
    pub = rospy.Publisher('Termine_avanzar_n_estados_correctos', String, queue_size=10)
    rospy.Subscriber("/avanzar_n_estados_correctos", Int32MultiArray, callback)
    rospy.spin()
