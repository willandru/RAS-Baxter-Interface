...
def cantidad_colores(color,Orderold):
    ...
    continuar=0
    if color==4:
	    if obstaculos_aux==obstaculos and ((azul_aux==2 and verde_aux==2 and rojo_aux==0 and amarillo_aux==0) or (azul_aux==2 and verde_aux==0 and rojo_aux==2 and amarillo_aux==0) or (azul_aux==2 and verde_aux==0 and rojo_aux==0 and amarillo_aux==2) or (azul_aux==0 and verde_aux==2 and rojo_aux==2 and amarillo_aux==0) or (azul_aux==0 and verde_aux==2 and rojo_aux==0 and amarillo_aux==2) or (azul_aux==0 and verde_aux==0 and rojo_aux==2 and amarillo_aux==2)):
		continuar=1
    if color==8:
	    if obstaculos_aux==obstaculos and ((azul_aux==4 and verde_aux==4 and rojo_aux==0 and amarillo_aux==0) or (azul_aux==4 and verde_aux==0 and rojo_aux==4 and amarillo_aux==0) or (azul_aux==4 and verde_aux==0 and rojo_aux==0 and amarillo_aux==4) or (azul_aux==0 and verde_aux==4 and rojo_aux==4 and amarillo_aux==0) or (azul_aux==0 and verde_aux==4 and rojo_aux==0 and amarillo_aux==4) or (azul_aux==0 and verde_aux==0 and rojo_aux==4 and amarillo_aux==4)):
		continuar=1
